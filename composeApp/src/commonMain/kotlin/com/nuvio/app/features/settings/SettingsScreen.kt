...
fun SettingsScreen(
    ...
    BoxWithConstraints(
        ...
        var navigationOrigin by rememberSaveable { mutableStateOf<String?>(null) }
        ...
        PlatformBackHandler(
            enabled = (previousPage != null || navigationOrigin != null) && (rootActionsEnabled || onExternalBack != null),
            onBack = ::navigateBack,
        )
        ...
        if (maxWidth >= 768.dp) {
            TabletSettingsScreen(
                ...
                episodeCodeFormat = playerSettingsUiState.episodeCodeFormat,
                ...
                glassNavBarEnabled = glassNavBarEnabled,
                ...
                animeContinueWatchingPreferencesUiState = animeContinueWatchingPreferencesUiState,
...
private fun MobileSettingsScreen(
    ...
    metaScreenSettingsUiState: MetaScreenSettingsUiState,
    continueWatchingPreferencesUiState: ContinueWatchingPreferencesUiState,
    animeContinueWatchingPreferencesUiState: ContinueWatchingPreferencesUiState,
    posterCardStyleUiState: PosterCardStyleUiState,
    onSwitchProfile: (() -> Unit)? = null,
    onHomescreenClick: () -> Unit = {},
    onMetaScreenClick: () -> Unit = {},
                ...
                if (showInternalHeader) {
                    stickyHeader {
                        NuvioScreenHeader(
                            ...
                            onBack = if (page != SettingsPage.Root) ({ onNavigateBack() }) else null,
                        )
                    }
                } else {
...
private fun TabletSettingsScreen(
    ...
    Row(modifier = Modifier.fillMaxSize()) {
        ...
        saveableStateHolder.SaveableStateProvider("settings_tablet") {
            var settingsSearchQuery by rememberSaveable { mutableStateOf("") }
            var rootSearchVisible by rememberSaveable { mutableStateOf(false) }
            var rootSearchRevealAnimating by rememberSaveable { mutableStateOf(false) }
            val hapticFeedback = LocalHapticFeedback.current
                    ...
                    when (page) {
                        SettingsPage.Root -> {
                            ...
                            if (settingsSearchQuery.isBlank()) {
                                ...
                                showAnimeSection = activeCategory == SettingsCategory.Anime,
