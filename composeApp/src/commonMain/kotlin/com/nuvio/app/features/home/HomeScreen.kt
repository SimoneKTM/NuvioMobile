...
fun HomeScreen(
    ...
    val cachedInProgressItems = remember(cachedSnapshots.second, isTraktProgressActive, episodeCodeFormat) {
        cachedSnapshots.second.mapNotNull { cached ->
            ...
            cached.resolvedProgressKey() to cached.toContinueWatchingItem(format = episodeCodeFormat)
        }.toMap()
    }
                ...
                homeUiState.sections.isEmpty() && homeUiState.heroItems.isEmpty() &&
                    ...
                    if (homeUiState.top10MovieItems.isNotEmpty()) {
                        item(key = "top10_movies") {
                            HomeTop10Section(
                                title = stringResource(Res.string.home_top10_movies),
                    ...
                    if (homeUiState.top10SeriesItems.isNotEmpty()) {
                        item(key = "top10_series") {
                            HomeTop10Section(
                                title = stringResource(Res.string.home_top10_series),
