...
object MalApiClient {
    ...
    suspend fun getUserAnimeList(
        ...
        limit: Int = 1000,
        offset: Int = 0,
        fields: String = "id,title,main_picture,synopsis,mean,num_episodes,status,genres,media_type,start_date,list_status",
    ...
    suspend fun updateAnimeListStatus(
        ...
        return try {
            val response = httpRequestRaw(
                ...
                body = body,
                headers = authHeaders(accessToken) + mapOf("Content-Type" to "application/x-www-form-urlencoded"),
            )
