    ...
    Box(
        modifier = Modifier
            ...
            .playerSurfaceDragGestures(
                ...
                isLiveContentState = gestureCallbacks.isLiveContent,
        ...
        AnimatedVisibility(
            visible = pausedOverlayVisible && !controlsVisible && !playerControlsLocked && activeProviderAddonId != "live-tv",
...
private fun PlayerScreenRuntime.RenderPlayerControls(displayedPositionMs: Long, isEpisode: Boolean) {
    val isInPip = rememberIsInPictureInPicture()
    AnimatedVisibility(
        visible = (controlsVisible || contentType == "live" || showParentalGuide) && !playerControlsLocked && !isInPip,
        enter = fadeIn(),
        exit = fadeOut(),
    ) {
        PlayerControlsShell(
