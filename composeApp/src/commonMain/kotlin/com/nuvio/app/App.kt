...
import com.nuvio.app.core.logging.InAppLogWriter
...
private fun AppScreenTab.toNativeNavigationTab(): NativeNavigationTab = when (this) {
    ...
    AppScreenTab.Anime -> NativeNavigationTab.Anime
...
private fun NativeNavigationTab.toAppScreenTab(): AppScreenTab = when (this) {
    ...
    NativeNavigationTab.Anime -> AppScreenTab.Anime
...
private fun MainAppContent(
    ...
    onSwitchProfile: () -> Unit = {},
        ...
        val animeScrollToTopRequests = remember { MutableSharedFlow<Unit>(extraBufferCapacity = 1) }
    ...
    fun handleRootTabClick(tab: AppScreenTab) {
        ...
        when (tab) {
            ...
            AppScreenTab.Anime -> animeScrollToTopRequests.tryEmit(Unit)
            AppScreenTab.Search -> {
    ...
    LaunchedEffect(currentRoute) {
        ...
        Box(
            ...
            SharedTransitionLayout {
                                ...
                                if (!isTabletLayout && !useNativeBottomTabs) {
                                    CompositionLocalProvider(LocalHazeState provides hazeState) {
                                        NuvioNavigationBar(
                                            ...
                                            if (liveTvUiState.showInNavigation) {
                                                NavItem(
                            ...
                            Box(
                                ...
                                CompositionLocalProvider(
                                    ...
                                    AppTabHost(
                                        ...
                                        animeScrollToTopRequests = animeScrollToTopRequests,
                ...
                entry<AnimeProfileSettingsRoute> { route ->
                    val onBack = rememberGuardedPopBackStack(
                        navController = navController,
                        route = route,
                    )
...
private fun AppTabHost(
    ...
    animeScrollToTopRequests: Flow<Unit>,
    ...
    onAnimeSettingsClick: (() -> Unit)? = null,
    ...
    Box(modifier = modifier.fillMaxSize()) {
        tabStateHolder.SaveableStateProvider(selectedTab.name) {
            when (selectedTab) {
                ...
                AppScreenTab.Anime -> {
                    com.nuvio.app.features.animeprofile.AnimeTabScreen(
                        modifier = Modifier.fillMaxSize(),
