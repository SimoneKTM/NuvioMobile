...
actual object AnimeTmdbSettingsStorage {
    private const val preferencesName = "nuvio_anime_tmdb_settings"
    private const val enabledKey = "anime_tmdb_enabled"
    private const val apiKeyKey = "anime_tmdb_api_key"
    private const val languageKey = "anime_tmdb_language"
    private const val useTrailersKey = "anime_tmdb_use_trailers"
    private const val useArtworkKey = "anime_tmdb_use_artwork"
    private const val useBasicInfoKey = "anime_tmdb_use_basic_info"
    private const val useDetailsKey = "anime_tmdb_use_details"
    private const val useCreditsKey = "anime_tmdb_use_credits"
    private const val useProductionsKey = "anime_tmdb_use_productions"
    private const val useNetworksKey = "anime_tmdb_use_networks"
    private const val useEpisodesKey = "anime_tmdb_use_episodes"
    private const val useSeasonPostersKey = "anime_tmdb_use_season_posters"
    private const val useMoreLikeThisKey = "anime_tmdb_use_more_like_this"
    private const val useCollectionsKey = "anime_tmdb_use_collections"
