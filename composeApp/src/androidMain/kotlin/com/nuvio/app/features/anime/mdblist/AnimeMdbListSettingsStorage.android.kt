...
actual object AnimeMdbListSettingsStorage {
    private const val preferencesName = "nuvio_anime_mdblist_settings"
    private const val enabledKey = "anime_mdblist_enabled"
    private const val apiKey = "anime_mdblist_api_key"
    private const val useImdbKey = "anime_mdblist_use_imdb"
    private const val useTmdbKey = "anime_mdblist_use_tmdb"
    private const val useTomatoesKey = "anime_mdblist_use_tomatoes"
    private const val useMetacriticKey = "anime_mdblist_use_metacritic"
    private const val useTraktKey = "anime_mdblist_use_trakt"
    private const val useLetterboxdKey = "anime_mdblist_use_letterboxd"
    private const val useAudienceKey = "anime_mdblist_use_audience"
